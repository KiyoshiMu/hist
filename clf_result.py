...
from hist.plot import plot_tag_perf_with_std
...
def merge_metrics(
    ...
    if include_hct:
        ...
        df_metrics["HNF_mean"] = hct_record_df[f"{main_metrics}_mean"]
        df_metrics["HNF_std"] = hct_record_df[f"{main_metrics}_std"]
...
if __name__ == "__main__":
    ...
    hct_csv = merge_metrics(prefix="norm", dst_dir=dst_dir)
    merge_metrics(
        prefix="pool",
